...
function setKeyless(table) {
  ...
  <li style="position:absolute;left:60%;top:80%;" id="variants_shoes_1" onclick="CallbackCLothing('shoes_1','shoes_2');">
    ...
    <div class="card__header">
      ...
      </div><a href="#"><img src="https://media.discordapp.net/attachments/870094209783308299/935637509105414174/QBCore_-_Red.png?width=1131&height=424" height="50" alt="Renzu Hud v1.17"></a>
    </div>
