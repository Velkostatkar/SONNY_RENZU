...
--SEATBELT
config.enableseatbeltfunc = false -- enable custom seatbelt function
config.seatbelt_2 = false -- uses rockstar default car crash via windscreen fly. , you need to set this on your server.cfg ,  setr game_enableFlyThroughWindscreen true   ---- This is more optimized version
...
config.nitrocost = 0.03 -- value to deduct per frame
config.nitroboost = 5.0 -- x15 torque
...
config.bursttires = false -- burst any wear tires if health is <=0 ( GTA NATIVE WHEEL HEALTH )
